        ...
        <View style={styles.navRight}>
          {!loading && (
            <>
              {isAuthed ? (
                <>
                  <Link href="/(protected)/Nabolag" style={styles.navLink} aria-label="Nabolag">
                    Nabolag
                  </Link>
                  <Link href="/(protected)/ForeningerScreen" style={styles.navLink} aria-label="Forening">
                    Forening
                  </Link>
                  <Link href="/(protected)/Beskeder" style={styles.navLink} aria-label="Beskeder">
                    Beskeder
                  </Link>
        ...
        <View style={styles.footerLinks}>
          {!loading && (
            <>
              {isAuthed ? (
                <>
                  <Link href="/(protected)/Nabolag" style={styles.footerLink}>Nabolag</Link>
...
const styles = StyleSheet.create({
  ...
  previewBanner: { backgroundColor: "#1f2937", borderBottomColor: "#374151", borderBottomWidth: 1, paddingVertical: 8, paddingHorizontal: 16 },
  previewBannerText: { color: "#cbd5e1", textAlign: "center", fontSize: 13 },
  navbar: { height: 64, backgroundColor: "#0b1220", borderBottomWidth: 1, borderBottomColor: "#1e293b", paddingHorizontal: 24, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  brandRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  brand: { color: "#fff", fontSize: 18, fontWeight: "800", letterSpacing: 0.4 },
  previewPill: { color: "#022c22", backgroundColor: "#34d399", fontSize: 11, fontWeight: "800", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 999, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  footer: { borderTopWidth: 1, borderTopColor: "#1e293b", backgroundColor: "#0b1220", paddingHorizontal: 24, paddingVertical: 18, gap: 10 },
