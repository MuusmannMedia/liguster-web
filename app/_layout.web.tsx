...
export default function WebLayout() {
  ...
  return (
    <View style={styles.page}>
          ...
          {!loading && (
            <>
              {isAuthed ? (
                <>
                  {/* Nav labels */}
                  <Link href="/(protected)/Nabolag" style={styles.navLink} aria-label="Nabolag">Nabolag</Link>
      ...
      {/* INDHOLD – vigtig ændring: ikke ScrollView */}
...
const styles = StyleSheet.create({
  ...
  content: {
    flex: 1,                 // ← gør at indholdet fylder siden og body kan scrolle
    minHeight: 0,            // ← vigtigt på web for korrekt flex-beregning
  },
