  ...
  return (
    <View style={styles.page}>
      <Head>
        ...
        {/* Tillad scroll overalt (også mobil-web) og undgå 100vh-lås */}
        <style>{`
      ...
      <View style={styles.nav}>
        ...
        <View style={styles.right}>
            ...
            <View style={{ position: "relative" }}>
              ...
              {menuOpen && (
                <View style={styles.menu}>
                  ...
                  <TouchableOpacity onPress={signOut} style={styles.logout}><Text style={styles.logoutTxt}>Log ud</Text></TouchableOpacity>
                </View>
              )}
            </View>
          )}
          ...
          {isAuthed ? (
            !isMobile && (
              <TouchableOpacity onPress={signOut} style={styles.cta}><Text style={styles.ctaTxt}>Log ud</Text></TouchableOpacity>
            )
          ) : (
      ...
      {/* Ingen footer – kun indhold. Vinduet scroller frit. */}
...
const styles = StyleSheet.create({
  ...
  menu: {
    ...
    backgroundColor: "#0b1220", borderWidth: 1, borderColor: "#1e293b", borderRadius: 12, paddingVertical: 8,
  },
